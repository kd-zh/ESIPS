...
def incorporate(img_path, compo_path, text_path, output_root, params,
                resize_by_height=None, show=False, wait_key=None):
    ...
    draw_bounding_box_class(org_resize, compos, show=show, name='ip', wait_key=None)
    draw_bounding_box(org_resize, texts, show=show, name='ocr', wait_key=None)
    ...
    draw_bounding_box_class(org_resize, compos_merged, name='merged line', show=show, wait_key=None)
    ...
    board = draw_bounding_box_class(org_resize, compos_merged, name='merged paragraph', is_return=True, show=show, wait_key=None)
