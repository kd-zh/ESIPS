import ocr_paddle_cpu
import ocr_canny


def ocr_run(image_file, cv_image, debug=False, timeout=20, resize_rate=None):
    return ocr_paddle_cpu.ocr_run(image_file, cv_image, debug=False, timeout=20, resize_rate=None)
...
def ocr_recognize(image_file, cv_image=None, debug=False, timeout=20, resize_rate=None):
    return ocr_paddle_cpu.ocr_recognize(image_file, cv_image, debug, timeout, resize_rate)
